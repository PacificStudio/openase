...
func (_c *UserCreate) SetPrimaryEmail(v string) *UserCreate {
	_c.mutation.SetPrimaryEmail(v)
	return _c
}

// SetNillablePrimaryEmail sets the "primary_email" field if the given value is not nil.
func (_c *UserCreate) SetNillablePrimaryEmail(v *string) *UserCreate {
	if v != nil {
...
func (_c *UserCreate) defaults() {
	...
	if _, ok := _c.mutation.PrimaryEmail(); !ok {
		v := user.DefaultPrimaryEmail
		_c.mutation.SetPrimaryEmail(v)
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.PrimaryEmail(); !ok {
		return &ValidationError{Name: "primary_email", err: errors.New(`ent: missing required field "User.primary_email"`)}
	}
	if _, ok := _c.mutation.DisplayName(); !ok {
