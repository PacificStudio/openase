...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ProjectRepo, c.ScheduledJob, c.Ticket, c.TicketComment,
...
type (
	hooks struct {
		...
		IssueConnector, Machine, NotificationChannel, NotificationRule,
		Organization, Project, ProjectRepo, ScheduledJob, Ticket, TicketComment,
		TicketCommentRevision, TicketDependency, TicketExternalLink,
		TicketRepoScope, TicketRepoWorkspace, TicketStatus, Workflow []ent.Hook
	}
	inters struct {
		ActivityEvent, Agent, AgentProvider, AgentRun, AgentStepEvent, AgentToken,
		AgentTraceEvent, ChatConversation, ChatEntry, ChatPendingInterrupt, ChatTurn,
		...
		Organization, Project, ProjectRepo, ScheduledJob, Ticket, TicketComment,
		TicketCommentRevision, TicketDependency, TicketExternalLink,
		TicketRepoScope, TicketRepoWorkspace, TicketStatus, Workflow []ent.Interceptor
	}
)
