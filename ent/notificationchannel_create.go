...
func (_c *NotificationChannelCreate) SetOrganizationID(v uuid.UUID) *NotificationChannelCreate {
...
func (_c *NotificationChannelCreate) SetID(v uuid.UUID) *NotificationChannelCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *NotificationChannelCreate) SetNillableID(v *uuid.UUID) *NotificationChannelCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *NotificationChannelCreate) check() error {
	if _, ok := _c.mutation.OrganizationID(); !ok {
		return &ValidationError{Name: "organization_id", err: errors.New(`ent: missing required field "NotificationChannel.organization_id"`)}
	}
	...
	if len(_c.mutation.OrganizationIDs()) == 0 {
		return &ValidationError{Name: "organization", err: errors.New(`ent: missing required edge "NotificationChannel.organization"`)}
	}
	return nil
}
