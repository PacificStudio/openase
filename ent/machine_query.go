...
func (_q *MachineQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *MachineQuery) WithOrganization(opts ...func(*OrganizationQuery)) *MachineQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
...
//		GroupBy(machine.FieldOrganizationID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Machine.Query().
//		Select(machine.FieldOrganizationID).
//		Scan(ctx, &v)
...
func (_q *MachineQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*Machine, init func(*Machine), assign func(*Machine, *Organization)) error {
...
func (_q *MachineQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withOrganization != nil {
			_spec.Node.AddColumnOnce(machine.FieldOrganizationID)
		}
	}
