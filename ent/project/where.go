...
func HasAgentRawEvents() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAgentRawEventsWith(preds ...predicate.AgentRawEvent) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
...
func HasAgentActivityInstances() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAgentActivityInstancesWith(preds ...predicate.AgentActivityInstance) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
...
func HasAgentTranscriptEntries() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAgentTranscriptEntriesWith(preds ...predicate.AgentTranscriptEntry) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
