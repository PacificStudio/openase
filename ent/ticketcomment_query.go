...
func (_q *TicketCommentQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *TicketCommentQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *TicketCommentQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *TicketCommentQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *TicketCommentQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *TicketCommentQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TicketCommentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(ticketcomment.Table, ticketcomment.Columns, sqlgraph.NewFieldSpec(ticketcomment.FieldID, field.TypeUUID))
	_spec.From = _q.sql
