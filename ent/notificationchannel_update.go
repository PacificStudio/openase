...
func (_u *NotificationChannelUpdate) SetOrganizationID(v uuid.UUID) *NotificationChannelUpdate {
	_u.mutation.SetOrganizationID(v)
	return _u
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (_u *NotificationChannelUpdate) SetNillableOrganizationID(v *uuid.UUID) *NotificationChannelUpdate {
	if v != nil {
...
func (_u *NotificationChannelUpdate) SetOrganization(v *Organization) *NotificationChannelUpdate {
...
func (_u *NotificationChannelUpdate) check() error {
	...
	if _u.mutation.OrganizationCleared() && len(_u.mutation.OrganizationIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "NotificationChannel.organization"`)
	}
	return nil
}
...
func (_u *NotificationChannelUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.OrganizationCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   notificationchannel.OrganizationTable,
			Columns: []string{notificationchannel.OrganizationColumn},
			Bidi:    false,
...
// SetOrganizationID sets the "organization_id" field.
func (_u *NotificationChannelUpdateOne) SetOrganizationID(v uuid.UUID) *NotificationChannelUpdateOne {
	_u.mutation.SetOrganizationID(v)
	return _u
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (_u *NotificationChannelUpdateOne) SetNillableOrganizationID(v *uuid.UUID) *NotificationChannelUpdateOne {
	if v != nil {
		_u.SetOrganizationID(*v)
	}
	return _u
...
// SetOrganization sets the "organization" edge to the Organization entity.
func (_u *NotificationChannelUpdateOne) SetOrganization(v *Organization) *NotificationChannelUpdateOne {
	return _u.SetOrganizationID(v.ID)
}
