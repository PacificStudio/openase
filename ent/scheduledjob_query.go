...
func (_q *ScheduledJobQuery) QueryProject() *ProjectQuery {
...
func (_q *ScheduledJobQuery) QueryWorkflow() *WorkflowQuery {
...
func (_q *ScheduledJobQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ScheduledJobQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ScheduledJobQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ScheduledJobQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ScheduledJobQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *ScheduledJobQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ScheduledJobQuery) WithProject(opts ...func(*ProjectQuery)) *ScheduledJobQuery {
	query := (&ProjectClient{config: _q.config}).Query()
...
func (_q *ScheduledJobQuery) WithWorkflow(opts ...func(*WorkflowQuery)) *ScheduledJobQuery {
	query := (&WorkflowClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(scheduledjob.FieldProjectID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.ScheduledJob.Query().
//		Select(scheduledjob.FieldProjectID).
//		Scan(ctx, &v)
...
func (_q *ScheduledJobQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ScheduledJob, error) {
	...
	if query := _q.withProject; query != nil {
		if err := _q.loadProject(ctx, query, nodes, nil,
			func(n *ScheduledJob, e *Project) { n.Edges.Project = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withWorkflow; query != nil {
		if err := _q.loadWorkflow(ctx, query, nodes, nil,
			func(n *ScheduledJob, e *Workflow) { n.Edges.Workflow = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ScheduledJobQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*ScheduledJob, init func(*ScheduledJob), assign func(*ScheduledJob, *Project)) error {
...
func (_q *ScheduledJobQuery) loadWorkflow(ctx context.Context, query *WorkflowQuery, nodes []*ScheduledJob, init func(*ScheduledJob), assign func(*ScheduledJob, *Workflow)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*ScheduledJob)
	for i := range nodes {
...
func (_q *ScheduledJobQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(scheduledjob.Table, scheduledjob.Columns, sqlgraph.NewFieldSpec(scheduledjob.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withProject != nil {
			_spec.Node.AddColumnOnce(scheduledjob.FieldProjectID)
		}
		if _q.withWorkflow != nil {
			_spec.Node.AddColumnOnce(scheduledjob.FieldWorkflowID)
		}
	}
