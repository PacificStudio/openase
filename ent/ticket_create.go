...
func (_c *TicketCreate) AddAgentRawEventIDs(ids ...uuid.UUID) *TicketCreate {
	_c.mutation.AddAgentRawEventIDs(ids...)
	return _c
}

// AddAgentRawEvents adds the "agent_raw_events" edges to the AgentRawEvent entity.
func (_c *TicketCreate) AddAgentRawEvents(v ...*AgentRawEvent) *TicketCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TicketCreate) AddAgentActivityInstanceIDs(ids ...uuid.UUID) *TicketCreate {
...
func (_c *TicketCreate) AddAgentActivityInstances(v ...*AgentActivityInstance) *TicketCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TicketCreate) AddAgentTranscriptEntryIDs(ids ...uuid.UUID) *TicketCreate {
...
func (_c *TicketCreate) AddAgentTranscriptEntries(v ...*AgentTranscriptEntry) *TicketCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
