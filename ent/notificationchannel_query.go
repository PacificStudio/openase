...
func (_q *NotificationChannelQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *NotificationChannelQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *NotificationChannelQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *NotificationChannelQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *NotificationChannelQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *NotificationChannelQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *NotificationChannelQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *NotificationChannelQuery) WithOrganization(opts ...func(*OrganizationQuery)) *NotificationChannelQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
...
//		GroupBy(notificationchannel.FieldOrganizationID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.NotificationChannel.Query().
//		Select(notificationchannel.FieldOrganizationID).
//		Scan(ctx, &v)
...
func (_q *NotificationChannelQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*NotificationChannel, init func(*NotificationChannel), assign func(*NotificationChannel, *Organization)) error {
...
func (_q *NotificationChannelQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withOrganization != nil {
			_spec.Node.AddColumnOnce(notificationchannel.FieldOrganizationID)
		}
	}
