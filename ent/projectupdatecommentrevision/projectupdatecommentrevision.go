...
const (
	// Label holds the string label denoting the projectupdatecommentrevision type in the database.
	Label = "project_update_comment_revision"
	...
	EdgeComment = "comment"
	// Table holds the table name of the projectupdatecommentrevision in the database.
	Table = "project_update_comment_revisions"
	// CommentTable is the table that holds the comment relation/edge.
	CommentTable = "project_update_comment_revisions"
	...
	CommentInverseTable = "project_update_comments"
