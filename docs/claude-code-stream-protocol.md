...
- [`internal/infra/adapter/claudecode/adapter.go`](/home/yuzhong/workspace/openase/internal/infra/adapter/claudecode/adapter.go)
- [`internal/provider/claudecode.go`](/home/yuzhong/workspace/openase/internal/provider/claudecode.go)
- [`internal/orchestrator/claude_protocol.go`](/home/yuzhong/workspace/openase/internal/orchestrator/claude_protocol.go)
- [`internal/orchestrator/agent_adapter_claudecode.go`](/home/yuzhong/workspace/openase/internal/orchestrator/agent_adapter_claudecode.go)
...
- Claude Code reference bundle:
  - [`references/claude-code-source/claude-code-2.1.88/cli.js.map`](/home/yuzhong/workspace/openase/references/claude-code-source/claude-code-2.1.88/cli.js.map)
  - [`references/claude-code-source/claude-code-2.1.88/sdk-tools.d.ts`](/home/yuzhong/workspace/openase/references/claude-code-source/claude-code-2.1.88/sdk-tools.d.ts)
- Observed local Claude Code runs and adapter fixtures in:
  - [`internal/orchestrator/agent_adapter_test.go`](/home/yuzhong/workspace/openase/internal/orchestrator/agent_adapter_test.go)
...
These observed bridge extensions are intentionally kept explicit in [`claude_protocol.go`](/home/yuzhong/workspace/openase/internal/orchestrator/claude_protocol.go), so readers can tell they are not reference-backed schema guarantees.
