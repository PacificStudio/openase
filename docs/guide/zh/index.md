...
- [核心概念](./concepts.md) — 理解 Ticket、Workflow、Agent、Machine 之间的关系和协作方式
...
| 模块 | 说明 | 文档 |
|------|------|------|
| Project AI | 持久化 AI 对话工作区，用于规划需求、起草工单、操作项目状态 | [查看](./project-ai.md) |
...
- [Remote Runtime v1 部署指南](../../zh/remote-websocket-rollout.md) — 远程拓扑、迁移步骤、本地验证与运维启用指南
