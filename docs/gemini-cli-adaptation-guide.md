...
- [`references/gemini-cli/docs/cli/headless.md`](/home/yuzhong/workspace/openase/references/gemini-cli/docs/cli/headless.md)
- [`references/gemini-cli/packages/core/src/output/types.ts`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/core/src/output/types.ts)
- [`references/gemini-cli/packages/core/src/agent/types.ts`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/core/src/agent/types.ts)
- [`references/gemini-cli/packages/core/src/agent/event-translator.ts`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/core/src/agent/event-translator.ts)
- [`references/gemini-cli/packages/cli/src/nonInteractiveCliAgentSession.ts`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/cli/src/nonInteractiveCliAgentSession.ts)
- [`references/gemini-cli/docs/reference/tools.md`](/home/yuzhong/workspace/openase/references/gemini-cli/docs/reference/tools.md)

## Current OpenASE State

OpenASE currently uses Gemini in a very thin one-shot mode:

- [`internal/chat/runtime_gemini.go`](/home/yuzhong/workspace/openase/internal/chat/runtime_gemini.go)
...
Reference:
- [`event-translator.ts`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/core/src/agent/event-translator.ts)
...
Reference:
- [`agent/types.ts`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/core/src/agent/types.ts)
...
Reference contract:
- [`headless.md`](/home/yuzhong/workspace/openase/references/gemini-cli/docs/cli/headless.md)
- [`output/types.ts`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/core/src/output/types.ts)
...
Reference:
- [`nonInteractiveCliAgentSession.ts:591`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/cli/src/nonInteractiveCliAgentSession.ts#L591)
...
Reference:
- [`tools.md`](/home/yuzhong/workspace/openase/references/gemini-cli/docs/reference/tools.md)
...
- cancelled tool calls may still surface as `tool_result.status = success` in stream-json legacy parity mode
  - reference: [`nonInteractiveCliAgentSession.test.ts:2378`](/home/yuzhong/workspace/openase/references/gemini-cli/packages/cli/src/nonInteractiveCliAgentSession.test.ts#L2378)
