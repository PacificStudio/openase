...
如果你在设置期间选择 OIDC 模式，流程会指向双模式 IAM 契约
（[`docs/zh/iam-dual-mode-contract.md`](./iam-dual-mode-contract.md)）以及
OIDC 配置指南（[`docs/zh/human-auth-oidc-rbac.md`](./human-auth-oidc-rbac.md)）。
运行时适用于 Auth0、Azure Entra ID 等标准 OIDC 提供商。
