<script lang="ts">
  ...
  const workflows: WorkflowSummary[] = [
    ...
    },
    {
      ...
      type: 'test',
      pickupStatus: 'needs_tests',
      finishStatus: 'tests_passing',
      maxConcurrent: 5,
      maxRetry: 3,
      timeoutMinutes: 15,
      isActive: true,
      lastModified: '2026-03-19T14:00:00Z',
    ...
    },
    {
      ...
      name: 'Security Scan',
      type: 'security',
      pickupStatus: 'pending_scan',
      finishStatus: 'scan_complete',
      maxConcurrent: 2,
      maxRetry: 1,
      timeoutMinutes: 45,
      isActive: true,
      lastModified: '2026-03-18T10:15:00Z',
    ...
    },
    {
      ...
      type: 'doc',
      pickupStatus: 'needs_docs',
      finishStatus: 'docs_ready',
      maxConcurrent: 2,
      maxRetry: 1,
      timeoutMinutes: 20,
      isActive: false,
      lastModified: '2026-03-15T16:45:00Z',
    ...
    },
    {
      ...
      finishStatus: 'deployed',
      maxConcurrent: 1,
      maxRetry: 2,
      timeoutMinutes: 60,
      isActive: true,
      lastModified: '2026-03-20T06:00:00Z',
      recentSuccessRate: 64,
      version: 5,
    },
  ]
