...
const canonicalCases = [
  ...
  ['secret.created', 'Secret created', 'info'],
  ['secret.rotated', 'Secret rotated', 'warning'],
  ['secret.bound', 'Secret bound', 'info'],
  ['secret.unbound', 'Secret unbound', 'warning'],
  ['secret.disabled', 'Secret disabled', 'warning'],
  ['secret.deleted', 'Secret deleted', 'danger'],
