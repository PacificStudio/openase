...
export const activityEventCatalog: ActivityEventCatalogEntry[] = [
  ...
  { eventType: 'secret.created', label: 'Secret created', tone: 'info' },
  { eventType: 'secret.rotated', label: 'Secret rotated', tone: 'warning' },
  { eventType: 'secret.bound', label: 'Secret bound', tone: 'info' },
  { eventType: 'secret.unbound', label: 'Secret unbound', tone: 'warning' },
  { eventType: 'secret.disabled', label: 'Secret disabled', tone: 'warning' },
  { eventType: 'secret.deleted', label: 'Secret deleted', tone: 'danger' },
