...
type SkillEditorDataLoader = {
  mockResolvedValue(value: ReturnType<typeof buildSkillEditorData>): unknown
}

export async function renderSkillEditorPage(
  loadSkillEditorData: SkillEditorDataLoader,
