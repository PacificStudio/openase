...
export interface paths {
  ...
  '/api/v1/chat/conversations/{conversationId}/workspace/tree': {
    ...
    get: operations['getProjectConversationWorkspaceTree']
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface operations {
  ...
  getProjectConversationWorkspaceFile: {
    parameters: {
      query: {
        /** @description Repo name from the conversation workspace metadata response. */
        repo: string
        /** @description Required repo-relative file path. */
        path: string
      }
      header?: never
      path: {
    ...
    requestBody?: never
    responses: {
      /** @description Read one text file preview from the project conversation workspace response. */
      200: {
        headers: {
          [name: string]: unknown
        }
  ...
  getProjectConversationWorkspaceTree: {
    parameters: {
      query: {
        /** @description Repo name from the conversation workspace metadata response. */
        repo: string
        /** @description Optional repo-relative directory path to list. Defaults to the repo root. */
        path?: string
      }
      header?: never
      path: {
    ...
    requestBody?: never
    responses: {
      /** @description List one directory inside the project conversation workspace response. */
      200: {
        headers: {
          [name: string]: unknown
        }
