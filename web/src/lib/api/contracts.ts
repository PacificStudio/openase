...
export type AgentOutputResponse = DeepRequired<
  ResponseFor<'/api/v1/agents/{agentId}/output', 'get'>
>
export type AgentOutputEntry = ItemOf<AgentOutputResponse['entries']>
