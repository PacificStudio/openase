...
var intentionalCLIOpenAPIGaps = map[string]string{
	...
	contractKey("POST", "/api/v1/chat/conversations/{conversationId}/workspace/file"):                              "project conversation workspace file creation has no first-class CLI yet",
	contractKey("PATCH", "/api/v1/chat/conversations/{conversationId}/workspace/file"):                             "project conversation workspace file rename has no first-class CLI yet",
	contractKey("DELETE", "/api/v1/chat/conversations/{conversationId}/workspace/file"):                            "project conversation workspace file deletion has no first-class CLI yet",
	...
	contractKey("GET", "/api/v1/chat/conversations/{conversationId}/workspace/git-graph"):                          "project conversation workspace git graph inspection has no first-class CLI yet",
	...
	contractKey("POST", "/api/v1/chat/conversations/{conversationId}/workspace/checkout"):                          "project conversation workspace branch checkout has no first-class CLI yet",
	contractKey("GET", "/api/v1/chat/conversations/{conversationId}/workspace/repo-refs"):                          "project conversation workspace repo ref inspection has no first-class CLI yet",
	contractKey("GET", "/api/v1/chat/conversations/{conversationId}/workspace/search"):                             "project conversation workspace path search has no first-class CLI yet",
