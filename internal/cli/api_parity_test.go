...
var intentionalCLIOpenAPIGaps = map[string]string{
	...
	contractKey("GET", "/api/v1/projects/{projectId}/security-settings/secrets"):                                   "scoped secret inspection has no first-class CLI yet",
	contractKey("POST", "/api/v1/projects/{projectId}/security-settings/secrets"):                                  "scoped secret creation has no first-class CLI yet",
	contractKey("DELETE", "/api/v1/projects/{projectId}/security-settings/secrets/{secretId}"):                     "scoped secret deletion has no first-class CLI yet",
	contractKey("PATCH", "/api/v1/projects/{projectId}/security-settings/secrets/{secretId}"):                      "scoped secret metadata update has no first-class CLI yet",
	contractKey("POST", "/api/v1/projects/{projectId}/security-settings/secrets/{secretId}/rotate"):                "scoped secret rotation has no first-class CLI yet",
	contractKey("POST", "/api/v1/projects/{projectId}/security-settings/secrets/{secretId}/disable"):               "scoped secret disable has no first-class CLI yet",
	contractKey("POST", "/api/v1/projects/{projectId}/security-settings/secrets/resolve-for-runtime"):              "runtime secret resolution has no first-class CLI yet",
