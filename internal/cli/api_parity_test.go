...
var intentionalCLIOpenAPIGaps = map[string]string{
	...
	contractKey("DELETE", "/api/v1/skills/refinement-runs/{sessionId}"):                                            "skill refinement run teardown has no first-class CLI yet",
	...
	contractKey("POST", "/api/v1/skills/{skillId}/refinement-runs"):                                                "skill refinement start has no first-class CLI yet",
