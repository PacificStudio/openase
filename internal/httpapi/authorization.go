...
func humanRouteAuthorizationRuleFor(path string, method string) (humanRouteAuthorizationRule, bool) {
	...
	case "/api/v1/projects/:projectId", "/api/v1/projects/:projectId/activity", "/api/v1/projects/:projectId/events/stream", "/api/v1/projects/:projectId/updates", "/api/v1/projects/:projectId/updates/:threadId", "/api/v1/projects/:projectId/updates/:threadId/revisions", "/api/v1/projects/:projectId/updates/:threadId/comments", "/api/v1/projects/:projectId/updates/:threadId/comments/:commentId", "/api/v1/projects/:projectId/updates/:threadId/comments/:commentId/revisions", "/api/v1/projects/:projectId/notification-rules", "/api/v1/projects/:projectId/scheduled-jobs", "/api/v1/projects/:projectId/skills", "/api/v1/projects/:projectId/skills/import", "/api/v1/projects/:projectId/skills/refresh", "/api/v1/projects/:projectId/workflows", "/api/v1/projects/:projectId/statuses", "/api/v1/projects/:projectId/statuses/reset", "/api/v1/projects/:projectId/tickets", "/api/v1/projects/:projectId/tickets/archived", "/api/v1/projects/:projectId/tickets/:ticketId/detail", "/api/v1/projects/:projectId/tickets/:ticketId/repo-scopes", "/api/v1/projects/:projectId/tickets/:ticketId/runs", "/api/v1/projects/:projectId/tickets/:ticketId/runs/:runId", "/api/v1/projects/:projectId/tickets/:ticketId/runs/:runId/raw-events", "/api/v1/projects/:projectId/tickets/:ticketId/runs/:runId/activities", "/api/v1/projects/:projectId/tickets/:ticketId/runs/:runId/transcript", "/api/v1/projects/:projectId/repos", "/api/v1/projects/:projectId/token-usage", "/api/v1/projects/:projectId/github/namespaces", "/api/v1/projects/:projectId/github/repos", "/api/v1/projects/:projectId/agents", "/api/v1/projects/:projectId/agent-runs", "/api/v1/projects/:projectId/agents/:agentId/output", "/api/v1/projects/:projectId/agents/:agentId/output/stream", "/api/v1/projects/:projectId/agents/:agentId/steps", "/api/v1/projects/:projectId/agents/:agentId/steps/stream", "/api/v1/projects/:projectId/security-settings", "/api/v1/projects/:projectId/security-settings/api-keys", "/api/v1/projects/:projectId/security-settings/secrets", "/api/v1/projects/:projectId/security-settings/secrets/resolve-for-runtime", "/api/v1/projects/:projectId/security-settings/secret-bindings", "/api/v1/projects/:projectId/security-settings/github-outbound-credential", "/api/v1/projects/:projectId/security-settings/github-outbound-credential/import-gh-cli", "/api/v1/projects/:projectId/security-settings/github-outbound-credential/retest", "/api/v1/projects/:projectId/hr-advisor", "/api/v1/projects/:projectId/hr-advisor/activate", "/api/v1/projects/:projectId/role-bindings", "/api/v1/projects/:projectId/role-bindings/:bindingId", "/api/v1/chat/projects/:projectId/conversations/stream":
		return humanRouteAuthorizationRule{
	...
	case "/api/v1/projects/:projectId/security-settings/api-keys/:keyId", "/api/v1/projects/:projectId/security-settings/api-keys/:keyId/rotate", "/api/v1/projects/:projectId/security-settings/api-keys/:keyId/disable", "/api/v1/projects/:projectId/security-settings/secrets/:secretId", "/api/v1/projects/:projectId/security-settings/secrets/:secretId/rotate", "/api/v1/projects/:projectId/security-settings/secrets/:secretId/disable", "/api/v1/projects/:projectId/security-settings/secret-bindings/:bindingId":
		return humanRouteAuthorizationRule{
			scopeResolver: humanRouteScopeResolverProject,
			resource:      "project",
			paramName:     "projectId",
	...
	case "/api/v1/chat/conversations/:conversationId",
